...
class AccountEdit extends Component {
  constructor(props) {
    ...
    this.handleHighschoolPositionChange = this.handleHighschoolPositionChange.bind(this);
    this.handleHighschoolGoalsChange = this.handleHighschoolGoalsChange.bind(this);
    this.handleHighschoolChange = this.handleHighschoolChange.bind(this);
    this.handleHighschoolAssistsChange = this.handleHighschoolAssistsChange.bind(this);
    this.handleHighlightVideoLinkChange = this.handleHighlightVideoLinkChange.bind(this);
    this.handleHeightChange = this.handleHeightChange.bind(this);
    this.handleGraduationYearChange = this.handleGraduationYearChange.bind(this);
    this.handleFullGameLinkChange = this.handleFullGameLinkChange.bind(this);
    this.handleFootChange = this.handleFootChange.bind(this);
    this.handleClubPositionChange = this.handleClubPositionChange.bind(this);
    this.handleClubNameChange = this.handleClubNameChange.bind(this);
    this.handleClubGoalsChange = this.handleClubGoalsChange.bind(this);
    this.handleClubAssistsChange = this.handleClubAssistsChange.bind(this);
    this.handleCityChange = this.handleCityChange.bind(this);
    this.handleActScoreChange = this.handleActScoreChange.bind(this);
